...
std__list_E_EC = std(All_E_EC);
norm_std_list = std__list_E_EC./mean_list_E_EC; 
norm_std_list(1)=0;
norm_range_list = range_list_E_EC./mean_list_E_EC;
norm_range_list(1) =0;
...
hold on
subplot(2,1,1);
% plot(T_EC,min_list_E_EC,'r','LineWidth',2)
hold on
% plot(T_EC,max_list_E_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,range_list_E_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,mean_list_E_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,var_list_E_EC,'r','LineWidth',2)

% hold on
plot(T_EC,norm_std_list_E_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,norm_range_list_E_EC,'r','LineWidth',2)


subplot(2,1,2);
% plot(T_EC,min_list_L_EC,'r','LineWidth',2)
hold on
% plot(T_EC,max_list_L_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,range_list_L_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,mean_list_L_EC,'r','LineWidth',2)
% hold on
% plot(T_EC,var_list_L_EC,'r','LineWidth',2)

% subplot(2,1,1);
% hold on
plot(T_EC,norm_std_list,'r','LineWidth',2)
% subplot(2,1,2);
% hold on
% plot(T_EC,norm_range_list,'r','LineWidth',2)
